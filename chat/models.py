...
class RolePlayingRoom(models.Model):
    ...
    situation_en = models.CharField(
        max_length=100,
        blank=True,
        verbose_name="Situation (English)",
        help_text="Directly used in GPT prompt. If left blank, it will be automatically translated from the situation field.",
    )
    my_role = models.CharField(max_length=100, verbose_name="My Role")
    my_role_en = models.CharField(
        max_length=100,
        blank=True,
        verbose_name="My Role (English)",
        help_text="Directly used in GPT prompt. If left blank, it will be automatically translated from my_role field.",
    )
    gpt_role = models.CharField(max_length=100, verbose_name="GPT Role")
    gpt_role_en = models.CharField(
        max_length=100,
        blank=True,
        verbose_name="GPT Role (English)",
        help_text="Directly used in GPT prompt. If left blank, it will be automatically translated from gpt_role field.",
    )
